...
<script>
  ...
  import Base from '../perrmissiontree/base'
  ...
  import WorkgroupAdd from '../perrmissiontree//workgroup/add.vue'
  import PositionAdd from '../perrmissiontree//position/add.vue'
  import EmployeeAdd from '../perrmissiontree//member-management/add.vue'
  export default {
    name: 'per-tree',
    mixins: [BaseVue, Base],
    components: {
